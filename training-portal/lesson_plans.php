...
// Fetch lesson plans
$lp_sql = "SELECT * FROM lesson_plans WHERE subject_id = $subject_id";
...
<head>
  <meta charset="UTF-8" />
  <title>Lesson Plans - <?php echo htmlspecialchars($subject_name); ?></title>
...
<body class="bg-gray-100 text-gray-800">
  <div class="max-w-5xl mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-blue-900 mb-6">📄 Lesson Plans - <?php echo htmlspecialchars($subject_name); ?></h1>
    ...
    <?php else: ?>
      <p class="text-gray-600">No lesson plans available for this subject.</p>
    <?php endif; ?>
  </div>
 <!-- Footer -->
<footer>
